...
export function V2ThreeDistributionGlobe() {
  ...
  return (
    <div className="relative w-full h-[460px] sm:h-[520px] rounded-2xl overflow-hidden bg-[#020815] border border-cyan-400/25 shadow-[inset_0_0_40px_rgba(0,163,224,0.15)] flex flex-col justify-between">
      ...
      <div className="relative z-20 px-3.5 sm:px-4 pointer-events-none">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-lg bg-[#07172F]/90 backdrop-blur-md border border-cyan-400/30 text-[11px] text-cyan-200 shadow-md">
          ...
          <span>Projected: <strong>{selectedHub.name}</strong> · {selectedHub.projection}</span>
        </div>
      </div>
      ...
      <div className="relative z-20 m-3 sm:m-4 p-2.5 rounded-xl bg-[#040E20]/90 backdrop-blur-md border border-cyan-500/25 flex flex-col sm:flex-row sm:items-center justify-between gap-2 shadow-xl">
        <div className="flex items-center gap-1.5 flex-wrap">
          <span className="text-[10px] uppercase font-bold text-[#00E5FF] tracking-wider shrink-0 mr-1">
            Active Hubs:
          </span>
