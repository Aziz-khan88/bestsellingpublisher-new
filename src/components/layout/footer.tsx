        ...
        <div className="flex flex-col lg:flex-row items-start justify-between gap-10 lg:gap-0 pb-16">
          ...
          <div className="w-full lg:w-[27%] lg:pr-4 flex flex-col justify-between">
            ...
            <div className="mt-8 flex items-center gap-2.5 flex-wrap">
              ...
              <a
                href="#"
                className="w-8 h-8 rounded-full border border-slate-700/90 bg-black hover:border-[#00A3E0] hover:text-[#00A3E0] text-slate-200 flex items-center justify-center transition-all text-xs font-bold shadow-sm hover:shadow-[0_0_10px_rgba(0,163,224,0.4)] active:scale-95"
                aria-label="Facebook"
              >
                f
              </a>
              ...
              <a
                href="#"
                className="w-8 h-8 rounded-full border border-slate-700/90 bg-black hover:border-[#00A3E0] hover:text-[#00A3E0] text-slate-200 flex items-center justify-center transition-all text-xs shadow-sm hover:shadow-[0_0_10px_rgba(0,163,224,0.4)] active:scale-95"
          ...
          <div className="w-full lg:w-[19%]">
            ...
            <ul className="space-y-3.5 text-[13.5px] sm:text-[14px] text-white">
              <li className="flex items-start gap-2.5">
                <Mail className="w-4 h-4 text-[#00A3E0] shrink-0 mt-0.5" />
                <a
